...
const AboutSection = () => {
  ...
  return (
    <section id="sobre" className="py-24 bg-gradient-to-br from-gray-50 via-blue-50/30 to-orange-50/30 relative overflow-hidden">
      {/* Background Effects */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-16">
          <div className="space-y-6">
            ...
            <div className="flex items-center space-x-4 p-6 bg-white/80 backdrop-blur-sm rounded-2xl border border-gray-100">
              ...
              <div>
                <h4 className="font-semibold text-gray-900">100% Personalizado</h4>
                <p className="text-gray-600">Cada projeto é único, assim como seu negócio</p>
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {values.map((value, index) => (
            <div
              key={index}
              className="group text-center p-6 bg-white/80 backdrop-blur-sm rounded-2xl border border-gray-100 hover:border-crew-blue-200 transition-all duration-300 hover:shadow-xl hover:-translate-y-2 futuristic-hover"
            >
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-r from-crew-blue-50 to-crew-orange-50 mb-6 group-hover:scale-110 transition-transform duration-300">
                <value.icon className="text-crew-blue-600 w-8 h-8" />
              </div>
              
              <h3 className="text-xl font-bold text-gray-900 mb-4 group-hover:text-crew-blue-600 transition-colors duration-300">
                {value.title}
              </h3>
